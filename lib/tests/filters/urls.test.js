import resolveUrl from '../../_filters/urls.js';
...
describe('urlResolver', () => {
  ...
  test('should pass through protocol URLs unchanged', () => {
    const result = resolveUrl('https://nhs.net/index.html');
    expect(result).toBe('https://nhs.net/index.html');
  });
});
