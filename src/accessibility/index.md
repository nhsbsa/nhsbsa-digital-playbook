...
You can [estimate the number of people with a disability or condition that might impact how they use your service](https://accessibility.education.gov.uk/app/how-many-people/10000).
...
Any service that runs in a browser needs to meet the [Public Sector Bodies Accessibility Regulations 2018 (PSBAR)](https://accessibility-manual.dwp.gov.uk/accessibility-law/the-public-sector-bodies-accessibility-regulations-2018).
...
All services must:
- [meet the latest version of the Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/TR/WCAG22/)
...
- use tested patterns and components from the [NHS Design System](https://service-manual.nhs.uk/design-system) or [GOV.UK Design System](https://design-system.service.gov.uk/)
